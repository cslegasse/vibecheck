...
import { Shield, Plus, ArrowLeft, Brain, TrendingUp, BarChart3, Activity, Target, Award, Building2 } from "lucide-react";
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex gap-4 items-center">
              <Badge variant="outline" className="flex items-center gap-2">
                ...
                <span className="text-xs">Organization Dashboard</span>
              </Badge>
